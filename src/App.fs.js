import { dayOfWeek, addDays, date, now } from "./fable_modules/fable-library-js.4.24.0/Date.js";
...
import { tryFind, add, empty as empty_1 } from "./fable_modules/fable-library-js.4.24.0/Map.js";
...
function currentWeekMonday() {
    const today = now();
    return date(addDays(today, op_UnaryNegation_Int32((dayOfWeek(today) + 6) % 7)));
}

export function init() {
    const recipes = loadRecipes();
    const target = loadTarget();
    return new Model(recipes, defaultArg(loadWeekPlan(), new WeekPlan(currentWeekMonday(), empty())), target, new ActiveView_4(0, []), RecipeFormState_get_Empty(), empty_1({
        Compare: comparePrimitives,
    }), "", undefined, 0, undefined);
}

export function update(msg, model) {
    let bind$0040_2, bind$0040_3, bind$0040_4, bind$0040_5, bind$0040_6, bind$0040_7, bind$0040_8, bind$0040_9, bind$0040_10, bind$0040_11, bind$0040_12, bind$0040_13, bind$0040_14, bind$0040_15, bind$0040_16, bind$0040_17, bind$0040_18, bind$0040_19, bind$0040_20, bind$0040_21, bind$0040_22, matchValue_2, outArg_1, matchValue_3, outArg_2, matchValue_4, outArg_3, matchValue_5, outArg_4, matchValue_10, outArg_8, matchValue_11, outArg_9, matchValue_12, outArg_10, matchValue_13, outArg_11, id, matchValue, r_1;
    switch (msg.tag) {
        case 1: {
            const newPlan = new WeekPlan(model.WeekPlan.WeekStart, append(model.WeekPlan.Meals, singleton(new PlannedMeal(newGuid(), msg.fields[0], msg.fields[1], msg.fields[2], 1))));
        ...
        case 2: {
            const newPlan_1 = new WeekPlan(model.WeekPlan.WeekStart, filter((m) => (m.Id !== msg.fields[0]), model.WeekPlan.Meals));
        ...
        case 3:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, model.RecipeForm, model.GroceryChecked, model.SearchQuery, model.FilterCategory, msg.fields[0], model.SelectedMealType);
        case 4:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, model.RecipeForm, model.GroceryChecked, model.SearchQuery, model.FilterCategory, msg.fields[0], msg.fields[1]);
        case 5:
        ...
        case 6: {
            const newPlan_2 = new WeekPlan(addDays(model.WeekPlan.WeekStart, 7), empty());
        ...
        case 7: {
            const newPlan_3 = new WeekPlan(addDays(model.WeekPlan.WeekStart, -7), empty());
        ...
        case 8:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_2 = model.RecipeForm, new RecipeFormState(msg.fields[0], bind$0040_2.Description, bind$0040_2.Category, bind$0040_2.SuitableFor, bind$0040_2.Servings, bind$0040_2.PrepTime, bind$0040_2.CookTime, bind$0040_2.Ingredients, bind$0040_2.NewIngName, bind$0040_2.NewIngAmount, bind$0040_2.NewIngUnit, bind$0040_2.NewIngCategory, bind$0040_2.Instructions, bind$0040_2.NewInstruction, bind$0040_2.Calories, bind$0040_2.Protein, bind$0040_2.Carbs, bind$0040_2.Fat, bind$0040_2.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 9:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_3 = model.RecipeForm, new RecipeFormState(bind$0040_3.Name, msg.fields[0], bind$0040_3.Category, bind$0040_3.SuitableFor, bind$0040_3.Servings, bind$0040_3.PrepTime, bind$0040_3.CookTime, bind$0040_3.Ingredients, bind$0040_3.NewIngName, bind$0040_3.NewIngAmount, bind$0040_3.NewIngUnit, bind$0040_3.NewIngCategory, bind$0040_3.Instructions, bind$0040_3.NewInstruction, bind$0040_3.Calories, bind$0040_3.Protein, bind$0040_3.Carbs, bind$0040_3.Fat, bind$0040_3.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 10:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_4 = model.RecipeForm, new RecipeFormState(bind$0040_4.Name, bind$0040_4.Description, msg.fields[0], bind$0040_4.SuitableFor, bind$0040_4.Servings, bind$0040_4.PrepTime, bind$0040_4.CookTime, bind$0040_4.Ingredients, bind$0040_4.NewIngName, bind$0040_4.NewIngAmount, bind$0040_4.NewIngUnit, bind$0040_4.NewIngCategory, bind$0040_4.Instructions, bind$0040_4.NewInstruction, bind$0040_4.Calories, bind$0040_4.Protein, bind$0040_4.Carbs, bind$0040_4.Fat, bind$0040_4.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 11: {
            const mt = msg.fields[0];
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_5 = model.RecipeForm, new RecipeFormState(bind$0040_5.Name, bind$0040_5.Description, bind$0040_5.Category, contains(mt, model.RecipeForm.SuitableFor, {
                Equals: equals,
                GetHashCode: safeHash,
            }) ? filter((m_1) => !equals(m_1, mt), model.RecipeForm.SuitableFor) : cons(mt, model.RecipeForm.SuitableFor), bind$0040_5.Servings, bind$0040_5.PrepTime, bind$0040_5.CookTime, bind$0040_5.Ingredients, bind$0040_5.NewIngName, bind$0040_5.NewIngAmount, bind$0040_5.NewIngUnit, bind$0040_5.NewIngCategory, bind$0040_5.Instructions, bind$0040_5.NewInstruction, bind$0040_5.Calories, bind$0040_5.Protein, bind$0040_5.Carbs, bind$0040_5.Fat, bind$0040_5.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        }
        case 12:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_6 = model.RecipeForm, new RecipeFormState(bind$0040_6.Name, bind$0040_6.Description, bind$0040_6.Category, bind$0040_6.SuitableFor, msg.fields[0], bind$0040_6.PrepTime, bind$0040_6.CookTime, bind$0040_6.Ingredients, bind$0040_6.NewIngName, bind$0040_6.NewIngAmount, bind$0040_6.NewIngUnit, bind$0040_6.NewIngCategory, bind$0040_6.Instructions, bind$0040_6.NewInstruction, bind$0040_6.Calories, bind$0040_6.Protein, bind$0040_6.Carbs, bind$0040_6.Fat, bind$0040_6.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 13:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_7 = model.RecipeForm, new RecipeFormState(bind$0040_7.Name, bind$0040_7.Description, bind$0040_7.Category, bind$0040_7.SuitableFor, bind$0040_7.Servings, msg.fields[0], bind$0040_7.CookTime, bind$0040_7.Ingredients, bind$0040_7.NewIngName, bind$0040_7.NewIngAmount, bind$0040_7.NewIngUnit, bind$0040_7.NewIngCategory, bind$0040_7.Instructions, bind$0040_7.NewInstruction, bind$0040_7.Calories, bind$0040_7.Protein, bind$0040_7.Carbs, bind$0040_7.Fat, bind$0040_7.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 14:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_8 = model.RecipeForm, new RecipeFormState(bind$0040_8.Name, bind$0040_8.Description, bind$0040_8.Category, bind$0040_8.SuitableFor, bind$0040_8.Servings, bind$0040_8.PrepTime, msg.fields[0], bind$0040_8.Ingredients, bind$0040_8.NewIngName, bind$0040_8.NewIngAmount, bind$0040_8.NewIngUnit, bind$0040_8.NewIngCategory, bind$0040_8.Instructions, bind$0040_8.NewInstruction, bind$0040_8.Calories, bind$0040_8.Protein, bind$0040_8.Carbs, bind$0040_8.Fat, bind$0040_8.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 15:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_9 = model.RecipeForm, new RecipeFormState(bind$0040_9.Name, bind$0040_9.Description, bind$0040_9.Category, bind$0040_9.SuitableFor, bind$0040_9.Servings, bind$0040_9.PrepTime, bind$0040_9.CookTime, bind$0040_9.Ingredients, msg.fields[0], bind$0040_9.NewIngAmount, bind$0040_9.NewIngUnit, bind$0040_9.NewIngCategory, bind$0040_9.Instructions, bind$0040_9.NewInstruction, bind$0040_9.Calories, bind$0040_9.Protein, bind$0040_9.Carbs, bind$0040_9.Fat, bind$0040_9.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 16:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_10 = model.RecipeForm, new RecipeFormState(bind$0040_10.Name, bind$0040_10.Description, bind$0040_10.Category, bind$0040_10.SuitableFor, bind$0040_10.Servings, bind$0040_10.PrepTime, bind$0040_10.CookTime, bind$0040_10.Ingredients, bind$0040_10.NewIngName, msg.fields[0], bind$0040_10.NewIngUnit, bind$0040_10.NewIngCategory, bind$0040_10.Instructions, bind$0040_10.NewInstruction, bind$0040_10.Calories, bind$0040_10.Protein, bind$0040_10.Carbs, bind$0040_10.Fat, bind$0040_10.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 17:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_11 = model.RecipeForm, new RecipeFormState(bind$0040_11.Name, bind$0040_11.Description, bind$0040_11.Category, bind$0040_11.SuitableFor, bind$0040_11.Servings, bind$0040_11.PrepTime, bind$0040_11.CookTime, bind$0040_11.Ingredients, bind$0040_11.NewIngName, bind$0040_11.NewIngAmount, msg.fields[0], bind$0040_11.NewIngCategory, bind$0040_11.Instructions, bind$0040_11.NewInstruction, bind$0040_11.Calories, bind$0040_11.Protein, bind$0040_11.Carbs, bind$0040_11.Fat, bind$0040_11.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 18:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, (bind$0040_12 = model.RecipeForm, new RecipeFormState(bind$0040_12.Name, bind$0040_12.Description, bind$0040_12.Category, bind$0040_12.SuitableFor, bind$0040_12.Servings, bind$0040_12.PrepTime, bind$0040_12.CookTime, bind$0040_12.Ingredients, bind$0040_12.NewIngName, bind$0040_12.NewIngAmount, bind$0040_12.NewIngUnit, msg.fields[0], bind$0040_12.Instructions, bind$0040_12.NewInstruction, bind$0040_12.Calories, bind$0040_12.Protein, bind$0040_12.Carbs, bind$0040_12.Fat, bind$0040_12.ImageEmoji)), model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 19: {
        ...
        case 29: {
            ...
            if (f.Name.trim() === "") {
                ...
                const nutrition = new Nutrition((matchValue_2 = ((outArg_1 = 0, [tryParse(f.Calories, new FSharpRef(() => outArg_1, (v_15) => {
                    outArg_1 = v_15;
                })), outArg_1])), matchValue_2[0] ? matchValue_2[1] : 0), (matchValue_3 = ((outArg_2 = 0, [tryParse(f.Protein, new FSharpRef(() => outArg_2, (v_17) => {
                    outArg_2 = v_17;
                })), outArg_2])), matchValue_3[0] ? matchValue_3[1] : 0), (matchValue_4 = ((outArg_3 = 0, [tryParse(f.Carbs, new FSharpRef(() => outArg_3, (v_19) => {
                    outArg_3 = v_19;
                })), outArg_3])), matchValue_4[0] ? matchValue_4[1] : 0), (matchValue_5 = ((outArg_4 = 0, [tryParse(f.Fat, new FSharpRef(() => outArg_4, (v_21) => {
                    outArg_4 = v_21;
                })), outArg_4])), matchValue_5[0] ? matchValue_5[1] : 0));
                let servings;
                let matchValue_6;
                let outArg_5 = 0;
                ...
                servings = (matchValue_6[0] ? max(1, matchValue_6[1]) : 2);
                let prep;
                let matchValue_7;
                let outArg_6 = 0;
                ...
                prep = (matchValue_7[0] ? matchValue_7[1] : 0);
                let cook;
                let matchValue_8;
                let outArg_7 = 0;
                ...
                cook = (matchValue_8[0] ? matchValue_8[1] : 0);
                ...
                switch (matchResult) {
                    ...
                    default: {
                        const newRecipes_1 = append(model.Recipes, singleton(new Recipe(newGuid(), f.Name.trim(), f.Description.trim(), f.Category, f.SuitableFor, servings, prep, cook, f.Ingredients, f.Instructions, nutrition, f.ImageEmoji, false, now())));
        ...
        case 32: {
            const newRecipes_3 = filter((r_4) => (r_4.Id !== msg.fields[0]), model.Recipes);
        ...
        case 33:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, model.RecipeForm, model.GroceryChecked, msg.fields[0], model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        case 34:
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, model.RecipeForm, model.GroceryChecked, model.SearchQuery, msg.fields[0], model.SelectedDay, model.SelectedMealType);
        case 35: {
            const name_1 = msg.fields[0];
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, model.ActiveView, model.RecipeForm, add(name_1, !defaultArg(tryFind(name_1, model.GroceryChecked), false), model.GroceryChecked), model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        }
        case 36:
        ...
        case 37: {
            ...
            t = (new NutritionTarget((matchValue_10 = ((outArg_8 = 0, [tryParse(msg.fields[0], new FSharpRef(() => outArg_8, (v_30) => {
                outArg_8 = v_30;
            })), outArg_8])), matchValue_10[0] ? matchValue_10[1] : model.NutritionTarget.Calories), bind$0040_23.Protein, bind$0040_23.Carbs, bind$0040_23.Fat));
            saveTarget(t);
        ...
        case 38: {
            ...
            t_1 = (new NutritionTarget(bind$0040_24.Calories, (matchValue_11 = ((outArg_9 = 0, [tryParse(msg.fields[0], new FSharpRef(() => outArg_9, (v_32) => {
                outArg_9 = v_32;
            })), outArg_9])), matchValue_11[0] ? matchValue_11[1] : model.NutritionTarget.Protein), bind$0040_24.Carbs, bind$0040_24.Fat));
            saveTarget(t_1);
        ...
        case 39: {
            ...
            t_2 = (new NutritionTarget(bind$0040_25.Calories, bind$0040_25.Protein, (matchValue_12 = ((outArg_10 = 0, [tryParse(msg.fields[0], new FSharpRef(() => outArg_10, (v_34) => {
                outArg_10 = v_34;
            })), outArg_10])), matchValue_12[0] ? matchValue_12[1] : model.NutritionTarget.Carbs), bind$0040_25.Fat));
            saveTarget(t_2);
        ...
        case 40: {
            ...
            t_3 = (new NutritionTarget(bind$0040_26.Calories, bind$0040_26.Protein, bind$0040_26.Carbs, (matchValue_13 = ((outArg_11 = 0, [tryParse(msg.fields[0], new FSharpRef(() => outArg_11, (v_36) => {
                outArg_11 = v_36;
            })), outArg_11])), matchValue_13[0] ? matchValue_13[1] : model.NutritionTarget.Fat)));
            saveTarget(t_3);
        ...
        default: {
            ...
            return new Model(model.Recipes, model.WeekPlan, model.NutritionTarget, view_1, (view_1.tag === 3) ? ((view_1.fields[0] == null) ? RecipeFormState_get_Empty() : ((id = view_1.fields[0], (matchValue = tryFind_1((r) => (r.Id === id), model.Recipes), (matchValue == null) ? RecipeFormState_get_Empty() : ((r_1 = matchValue, new RecipeFormState(r_1.Name, r_1.Description, r_1.Category, r_1.SuitableFor, int32ToString(r_1.Servings), int32ToString(r_1.PrepTimeMinutes), int32ToString(r_1.CookTimeMinutes), r_1.Ingredients, "", "", new MeasureUnit(0, []), "Produce", r_1.Instructions, "", int32ToString(~~r_1.Nutrition.Calories), int32ToString(~~r_1.Nutrition.Protein), int32ToString(~~r_1.Nutrition.Carbs), int32ToString(~~r_1.Nutrition.Fat), r_1.ImageEmoji))))))) : model.RecipeForm, model.GroceryChecked, model.SearchQuery, model.FilterCategory, model.SelectedDay, model.SelectedMealType);
        }
    }
}
